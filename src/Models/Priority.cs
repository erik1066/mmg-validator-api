...
{
    /// <summary>
    /// Represents the 'CDC Priority' of a data element.
    /// </summary>
    ...
    public enum Priority
    {
        ...
        /// <summary>
        /// Required. Means the data element is mandatory for sending the message. If data element is not present, the message will error out.
        /// </summary>
        [EnumMember(Value = "R")]
        Required = 'R',
    }
